      ...
      <div>
        <header className="header">
          <a href="homepage.html" className="header__logo">
            <svg x="0px" y="0px" viewBox="0 0 77 14.7" className="logo" style={signupdiv}>
          ...
          <p className="header__text">Already have an account?</p>
          <NavLink to="/login" className="btn btn-o--purple"><span>Login</span></NavLink>   
        </header>
      </div>
    )
  }
