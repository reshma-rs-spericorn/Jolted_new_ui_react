    ...
    return (
      <div>
        <header className="header">
          <a href="homepage.html" className="header__logo">
            <svg x="0px" y="0px" viewBox="0 0 77 14.7" className="logo" style={divStyle}>
        ...
        s-1.5,0.3-2.1,0.9C57.6,7,57.3,7.8,57.3,8.6z M74.5,7.4l-2.6-2.5L77,0L74.5,7.4z M77,9.9l-5,4.9l2.5-7.3L77,9.9z"/>
          ...
          <p className="header__text">Don't have an account?</p>
          <NavLink to="/signup" className="btn btn-o--purple"><span>Request Invite</span></NavLink>
        </header>
      </div>
    )
  }
